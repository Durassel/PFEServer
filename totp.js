...
class TOTP {
   ...
   * @param {number} interval le nombre de secondes d'intervalle entre deux changemetns d'OTP
   */
  ...
  qrcode (name, issuer) {
	...
	qrcode.toFile('public/images/test.jpeg', uri, {type: 'image/png'}, function (err) {
  	if (err) throw err
	})
  }
}
